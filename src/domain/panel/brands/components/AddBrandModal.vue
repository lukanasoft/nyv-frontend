<template>
    <div class="modal-card" style="max-width: 600px">
        <header class="modal-card-head border-0" style="background-color: #0992CD;">
            <p class="modal-card-title has-text-left has-text-white" style="font-weight: 600">Agregar marca</p>
        </header>
        ...
        <footer class="modal-card-foot has-background-white is-flex is-align-items-center is-justify-content-end">
            <b-button class="button-blue-dashboard is-primary" @click="addBrand">Agregar</b-button>
        </footer>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        async addBrand() {
            ...
            await this.$store.dispatch('BrandStore/addBrand', {formData})
            this.closeModal()
        },
    },
    watch: {
