...
import ProductCard from '@/domain/products/components/ProductCard.vue';
import ModalDetail from '@/domain/products/components/ModalDetail.vue';
export default {
    name: "ProductsGrid",
    components: {
        ProductCard,
